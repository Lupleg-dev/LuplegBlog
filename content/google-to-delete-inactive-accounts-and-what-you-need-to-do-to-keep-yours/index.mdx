...
Google has announced that it will begin deleting inactive accounts in December 2023. This means that if you haven't signed in to your Google Account in two years, it may be deleted, along with all of the data associated with it.

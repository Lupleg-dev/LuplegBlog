...
[StyleXjs](https://styleXjs.org) was released by Meta in December, 2023 as an open source project. It gained popularity as a lightweight alternative to larger frameworks like React, Vue, and Angular for building component-based UIs.
...
```
stylex init otofast-project-app
```

This will generate a new folder called `otofast-project-app` with the default project structure:
...
- `src/index.jsx` - The entry point for your application
...
[StyleXjs](https://styleXjs.org) uses JSX, a syntax extension to JavaScript. It allows you to write HTML-like tags in JavaScript.

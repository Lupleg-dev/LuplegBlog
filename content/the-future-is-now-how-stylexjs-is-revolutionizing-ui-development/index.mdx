...
StyleXjs is a relatively new styling framework created by the company Modulz. Its goal is to provide an alternative to styled-components for React applications. 
